...
chipCfg.OptionalFeatureSupport |= FT_CONFIGURATION_OPTIONAL_FEATURE_SUPPORT_ENABLE_FIFO_IN_SUSPEND
print('New config option:', chipCfg.OptionalFeatureSupport)

dev.setChipConfiguration(chipCfg)
