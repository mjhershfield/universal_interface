########
# This code was provided by FTDI here: https://ftdichip.com/software-examples/ft600-601-software-examples-2/
########

import ftd3xx
import sys
if sys.platform == 'win32':
    from ftd3xx import _ftd3xx_win32 as _ft
else:
    from ftd3xx import _ftd3xx_linux as _ft
...
def CreateLogFile(logFile, logBuffer, bAppend=False):
    ...
    fileObject.write(str(logBuffer.hex()))	
    fileObject.close()
